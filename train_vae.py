...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        help="paths to base configs. Loaded from left-to-right. base_config.yaml"
             "Parameters can be overwritten or added with command-line options of the form `--key value`.",
        default="weights_encoding/configs/base_config.yaml",
    )
    parser.add_argument(
        "-t",
        "--train",
...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename="ckpt_vae_model_{epoch}_",
        every_n_epochs=1
    )
